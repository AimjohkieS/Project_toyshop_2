...
<form id="frmcart" name="frmcart" method="post" action="saveorder.php">
	<table width="600" border="0" align="center" class="square">
		...
		<tr>
			...
			<td align="center" bgcolor="#F9D5E3">รายการ</td>
		</tr>
<?php
	$total=0;
	...
	<tr>
		<td width="22%" bgcolor="#CCCCCC">ที่อยู่</td>
		<td width="78%">
	...
	<tr>
		...
		<td><input name="email" type="email" id="name" required/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="hidden" name="total" value="<?php echo $total;?>">
