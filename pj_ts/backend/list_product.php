...
echo  ' <table class="table table-hover">';
  ...
  echo "<tr>";
    ...
    //ลบข้อมูล
    echo "<td><a href='delete_from_product_db.php?ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'>del</a></td> ";
  echo "</tr>";
  }
echo "</table>";
//5. close connection
